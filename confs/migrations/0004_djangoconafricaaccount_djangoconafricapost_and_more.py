...
class Migration(migrations.Migration):
    dependencies = [
        ("confs", "0003_alter_fwd50post_account"),
    ]
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="posts",
                        to="confs.djangoconafricaaccount",
                    ),
                ),
            ],
        ),
        ...
        migrations.AddConstraint(
            model_name="djangoconafricaaccount",
            constraint=models.UniqueConstraint(fields=("url",), name="unique_djangoconafrica_url"),
        ),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=("url",), name="unique_post_djangoconafrica_url"),
        ),
        migrations.AlterUniqueTogether(
            name="djangoconafricapost",
